...
export const es: Dictionary = {
  ...
  work: {
    ...
    labels: {
      ...
      logistics: ["TERRESTRE · MARÍTIMO · AÉREO", "ALMACENAJE · ADUANA"],
    },
    stages: {
      logistics: ["ORIGEN · CONSOLIDACIÓN", "CARGA · PRECINTO", "TERRESTRE · PRIMERA MILLA", "PUERTO · HANDOVER EN TERMINAL", "OCÉANO · LARGA DISTANCIA", "AÉREO · TIME-CRITICAL", "DESTINO · ÚLTIMA MILLA"],
    },
  },
