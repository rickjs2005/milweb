...
export type Dictionary = {
  ...
  work: {
    ...
    all: string;
    clientWork: string;
    labels: { kavita: [string, string, string]; terral: [string, string, string]; vertex: [string, string, string, string, string]; aurex: [string, string, string]; inkvision: [string, string, string] };
  };
