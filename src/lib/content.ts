...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      gallery: [
        { src: "/shots/dagrao/intro.webp", alt: { pt: "Abertura estilo série: o brasão da Casa Dagrão se desenhando em brasa", en: "TV-series style opening: the House Dagrão sigil drawing itself in embers" } },
