...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    result: { pt: "Uma experiência-conceito que entra numa biblioteca ancestral proibida: hero em vídeo fullscreen com o dragão surgindo do relâmpago, cursor de brasa, cinzas subindo e trovão ocasional, e 8 capítulos que cruzam mito e ficção — nascimento do dragão em 6 mitologias (China, Japão, Europa medieval, Nórdica, Maia, Celta), os 10 dragões mais icônicos da ficção em cards 3D com glifo autoral próprio (sem usar still oficial de nenhuma obra), mapa mundial clicável, linha do tempo horizontal pinada no scroll, galeria de gravuras em domínio público, tabela comparativa de poder e uma silhueta final batendo asas devagar.", en: "A concept experience that opens into a forbidden ancient library: fullscreen video hero with the dragon emerging from lightning, an ember cursor, rising ash and occasional thunder, and 8 chapters bridging myth and fiction — the dragon's birth across 6 mythologies (China, Japan, medieval Europe, Norse, Maya, Celtic), fiction's 10 most iconic dragons in 3D cards with an original glyph mark each (no official stills used), a clickable world map, a horizontal timeline pinned on scroll, a gallery of public-domain engravings, a power comparison table and a final silhouette slowly beating its wings." },
