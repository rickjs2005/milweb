...
export const PROJECTS: Project[] = [
  ...
  {
    slug: "milweb-contratos",
    title: "MilWeb Contratos",
    tagline: { pt: "Automação de contratos · assinatura eletrônica", en: "Contract automation · e-signature" },
    problem: { pt: "Fechar projeto e fazer contrato na mão é lento e dá brecha pra erro — numeração, PDF, envio pra assinatura e acompanhamento.", en: "Closing a deal and drafting contracts by hand is slow and error-prone — numbering, PDF, signature dispatch and tracking." },
    result: { pt: "Plataforma que gera o contrato numerado, renderiza o PDF, dispara pra assinatura eletrônica e acompanha o status — orquestrada por webhooks/n8n, com provedor de assinatura plugável (ZapSign/Clicksign/DocuSign).", en: "Platform that generates the numbered contract, renders the PDF, sends it for e-signature and tracks status — orchestrated via webhooks/n8n, with a pluggable signing provider (ZapSign/Clicksign/DocuSign)." },
    stack: ["Next.js", "TypeScript", "Prisma", "PostgreSQL", "n8n", "Docker"],
    metric: { pt: "Do fechamento à assinatura, automatizado", en: "From deal to signature, automated" },
    status: { pt: "Em produção · interno MilWeb", en: "In production · MilWeb internal" },
    repos: [{ label: "Código", url: `${GH}/milweb-contratos` }],
    featured: true,
  },
  {
    slug: "kavita",
  ...
  },
  {
    ...
    tagline: { pt: "Vitrine geek cinematográfica · 3D + WebAudio", en: "Cinematic geek showcase · 3D + WebAudio" },
    ...
    result: { pt: "Vitrine conceitual com núcleo de energia 3D reativo ao mouse, cards com tilt real, scroll cinematográfico e som de UI procedural (WebAudio) — puro impacto de marca, 100% estático.", en: "Concept showcase with a mouse-reactive 3D energy core, real-tilt cards, cinematic scroll and procedural UI sound (WebAudio) — pure brand impact, 100% static." },
    stack: ["React", "Vite", "Three.js", "GSAP", "Framer Motion", "Tailwind"],
    metric: { pt: "Núcleo 3D + cards tilt + som de UI", en: "3D core + tilt cards + UI sound" },
  ...
  },
  {
    ...
    problem: { pt: "Achar e organizar clientes em potencial na mão consome horas e bagunça o follow-up.", en: "Finding and organizing prospects by hand eats hours and breaks follow-up." },
    result: { pt: "Pipeline que busca lojas reais no Google Maps (Places API), joga numa planilha sem duplicar, dispara e-mail dos novos leads e controla status por lead — tudo dentro do Google, sem servidor.", en: "Pipeline that pulls real stores from Google Maps (Places API), drops them into a sheet without duplicates, emails the new leads and tracks status per lead — all inside Google, serverless." },
    stack: ["Google Apps Script", "Places API", "Sheets", "Gmail", "Node"],
    metric: { pt: "Lead-gen automático · sem servidor", en: "Automated lead-gen · serverless" },
    status: { pt: "Ferramenta interna MilWeb", en: "MilWeb internal tool" },
    featured: false,
  },
  {
    slug: "milsaca",
