...
export const SERVICES: Service[] = [
  {
    ...
    benefits: [
      { icon: "Palette", title: { pt: "Design sob medida", en: "Tailor-made design" }, desc: { pt: "Identidade própria pra sua marca, nada de tema pronto igual ao do concorrente.", en: "A unique identity for your brand, not an off-the-shelf theme that looks like your competitor's." } },
      ...
      { icon: "Smartphone", title: { pt: "Perfeito no celular", en: "Perfect on mobile" }, desc: { pt: "Mobile-first: a maioria dos seus clientes chega pelo celular, e o site nasce pra isso.", en: "Mobile-first: most of your customers arrive on a phone, and the site is born for it." } },
  ...
  },
  {
    ...
    benefits: [
      { icon: "ShoppingCart", title: { pt: "Carrinho vira mensagem pronta", en: "Cart becomes a ready message" }, desc: { pt: "O cliente escolhe produtos, tamanho e quantidade, e o pedido cai formatado no seu WhatsApp.", en: "The customer picks products, size and quantity, and the order arrives formatted in your WhatsApp." } },
      ...
      { icon: "Search", title: { pt: "Aparece no Google", en: "Shows up on Google" }, desc: { pt: "Cada produto vira uma página indexável, com clientes te achando sem você postar.", en: "Every product becomes an indexable page, so customers find you without a single post." } },
      ...
      { icon: "Smartphone", title: { pt: "Experiência de app", en: "App-like experience" }, desc: { pt: "Rápido e fluido no celular, que é onde seus clientes realmente compram.", en: "Fast and fluid on mobile, which is where your customers actually buy." } },
  ...
  },
  {
    ...
    benefits: [
      { icon: "Target", title: { pt: "Foco total em conversão", en: "Total conversion focus" }, desc: { pt: "Estrutura de venda: promessa, prova, oferta e chamada, sem distração.", en: "A sales structure: promise, proof, offer and call to action, with zero distraction." } },
      ...
      { icon: "FlaskConical", title: { pt: "Feita pra testar", en: "Built to test" }, desc: { pt: "Estrutura preparada pra variações de título e oferta, pra você otimizar com dados e não com achismo.", en: "Structured for headline and offer variations, so you optimize with data instead of guesswork." } },
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: "Search", title: { pt: "Produtos no Google", en: "Products on Google" }, desc: { pt: "Cada produto vira página indexável com dados estruturados, o que significa tráfego grátis todo mês.", en: "Every product becomes an indexable page with structured data, which means free traffic every month." } },
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: "LineChart", title: { pt: "Relatórios em tempo real", en: "Real-time reports" }, desc: { pt: "Dashboards com os números que importam pra decidir, sem esperar fechamento do mês.", en: "Dashboards with the numbers that matter, with no waiting for month-end closing." } },
    ...
    steps: [
      ...
      { title: { pt: "Sprints", en: "Sprints" }, desc: { pt: "Entregas quinzenais funcionando, pra você acompanhar o progresso de verdade.", en: "Working deliveries every two weeks, so you follow real progress." } },
