...
0. **Olhar o Milo em produção com GPU real** (milweb.com.br, Chrome desktop): Boot → 1ª interação → rolar devagar; decidir sobre a limitação de alcance da mão (mover/escalar o Milo ou âncora na linha 2) e se o Milo fica ou volta o Compiler. Conferir também que o mobile recebe o SVG e que Lighthouse não regrediu (CLS ≈ 0,4 é pré-existente).
